  ...
  return (
    <section id="comecar" className="scroll-mt-20 bg-brand-hi">
      <div className="mx-auto max-w-5xl px-4 py-20 sm:py-28">
        <Reveal>
          <div className="surface-brand edge-light surface-brand-glow relative overflow-hidden rounded-card px-5 py-12 text-center sm:px-12 sm:py-20">
            <div
              aria-hidden="true"
              className="pointer-events-none absolute -top-32 left-1/2 size-96 -translate-x-1/2 rounded-full bg-brand/25 blur-[100px]"
            />
            <div className="relative">
              <h2 className="text-balance text-[clamp(1.75rem,5vw,2.5rem)] font-semibold leading-[1.15] tracking-tight text-ink">
              ...
              <div className="mt-9 flex flex-col items-center gap-4">
                <Link
                  to={CTA.primary.to}
                  className="inline-flex h-14 w-full max-w-xs items-center justify-center rounded-xl bg-brand px-8 font-medium text-white transition-colors hover:bg-brand-hi active:bg-brand-deep sm:w-auto"
                >
                  {CTA.primary.label}
                </Link>
                <Link
