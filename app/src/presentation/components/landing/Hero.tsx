 ...
 * com um conceito.
 *
 * No celular a ordem é dor, solução, botão: nada entre o título e o CTA.
 */
...
export function Hero() {
  ...
  return (
    <section id="home" className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-[90rem] px-4 pb-12 pt-28 sm:px-8 sm:pt-36 lg:pb-16 xl:pt-40">
