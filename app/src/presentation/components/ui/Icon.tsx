...
export const ICON_PATHS = {
  ...
  config: 'M12 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6ZM4.5 12a7.5 7.5 0 0 1 .3-2l-2-1.5 2-3.5 2.3 1a7.5 7.5 0 0 1 1.7-1L9.2 2h5.6l.4 2.5a7.5 7.5 0 0 1 1.7 1l2.3-1 2 3.5-2 1.5a7.5 7.5 0 0 1 0 4l2 1.5-2 3.5-2.3-1a7.5 7.5 0 0 1-1.7 1l-.4 2.5H9.2l-.4-2.5a7.5 7.5 0 0 1-1.7-1l-2.3 1-2-3.5 2-1.5a7.5 7.5 0 0 1-.3-2Z',
  ...
  calendario: 'M4 8h16M7 4v3M17 4v3M5 20h14a1 1 0 0 0 1-1V7a1 1 0 0 0-1-1H5a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1Z',
  ...
  objetivo: 'M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18ZM12 16a4 4 0 1 0 0-8 4 4 0 0 0 0 8ZM12 13a1 1 0 1 0 0-2 1 1 0 0 0 0 2Z',
...
const HABIT_ICON_PATHS: Readonly<Record<HabitIcon, string>> = {
  livro: 'M4 5.5A1.5 1.5 0 0 1 5.5 4H11v16H5.5A1.5 1.5 0 0 1 4 18.5v-13ZM20 5.5A1.5 1.5 0 0 0 18.5 4H13v16h5.5a1.5 1.5 0 0 0 1.5-1.5v-13Z',
  cerebro: 'M9 4a3 3 0 0 0-3 3 3 3 0 0 0-1 5.8V15a3 3 0 0 0 3 3h1V4ZM15 4a3 3 0 0 1 3 3 3 3 0 0 1 1 5.8V15a3 3 0 0 1-3 3h-1V4Z',
  halter: 'M4 9v6M7 7v10M17 7v10M20 9v6M7 12h10',
  lotus: 'M12 20c-4 0-7-2.5-8-6 3-1 5.5 0 8 3 2.5-3 5-4 8-3-1 3.5-4 6-8 6ZM12 17c-2-2.5-2-6 0-9 2 3 2 6.5 0 9Z',
